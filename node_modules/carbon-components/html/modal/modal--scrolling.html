...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-jm0vn7vdyae">Show
  modal</button>

<div data-modal id="modal-jm0vn7vdyae" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-jm0vn7vdyae-label" aria-describedby="modal-jm0vn7vdyae-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-jm0vn7vdyae-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-jm0vn7vdyae-heading">Modal heading</p>
