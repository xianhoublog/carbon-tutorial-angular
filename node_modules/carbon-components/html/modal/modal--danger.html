...
<button class="bx--btn bx--btn--danger" type="button" data-modal-target="#modal-hig7zf5i74q">Show
  modal</button>

<div data-modal id="modal-hig7zf5i74q" class="bx--modal bx--modal--danger" role="dialog"
  aria-modal="true" aria-labelledby="modal-hig7zf5i74q-label" aria-describedby="modal-hig7zf5i74q-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-hig7zf5i74q-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-hig7zf5i74q-heading">Modal heading</p>
