...
<button class="bx--btn bx--btn--primary" type="button" data-modal-target="#modal-blenxldkyz7">Show
  modal</button>

<div data-modal id="modal-blenxldkyz7" class="bx--modal " role="dialog"
  aria-modal="true" aria-labelledby="modal-blenxldkyz7-label" aria-describedby="modal-blenxldkyz7-heading" tabindex="-1">
  <div class="bx--modal-container">
    <div class="bx--modal-header">
      <p class="bx--modal-header__label bx--type-delta" id="modal-blenxldkyz7-label">Optional label</p>
      <p class="bx--modal-header__heading bx--type-beta" id="modal-blenxldkyz7-heading">Modal heading</p>
